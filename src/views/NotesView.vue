  ...
  <section class="hero-section">
    <div class="hero-inner">
      <div class="hero-text">
        ...
        <p class="hero-sub">Some notes. Not sure what the value add of personal notes is in the era of AI but they help me form opinions. So I just keep on keeping on.</p>
      </div>
